        ...
        <div>
          <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
            <div class="px-6 py-5">
              ...
              <div class="mt-2 text-3xl font-bold text-gray-900">${{ data.revenue_total.toFixed(2) }}</div>
            </div>
            <div class="px-6 py-5">
              <div class="text-sm font-medium text-gray-500">Total Profit</div>
              <div class="mt-2 text-3xl font-bold text-green-600">${{ data.profit_total.toFixed(2) }}</div>
            </div>
            <div class="px-6 py-5">
              <div class="text-sm font-medium text-gray-500">Profit Margin</div>
              <div class="mt-2 text-3xl font-bold text-gray-900">{{ data.profit_margin.toFixed(1) }}%</div>
            </div>
          </div>
        </div>
      </div>
