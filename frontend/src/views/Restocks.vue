          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    Are you sure you want to delete this visit to {{ selectedDeleteRestock?.location_name }} on {{ formatDate(selectedDeleteRestock?.visit_date) }}? 
                    This action will also reverse all inventory changes made during this visit.
...
const deleteRestock = async () => {
  try {
    await api.deleteVisit(selectedDeleteRestock.value.id)
